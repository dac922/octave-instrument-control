...
// PKG_ADD: autoload ("modbus_new_tcp", "__modbus__.oct");
...
//Connect
// PKG_ADD: autoload ("modbus_connect", "__modbus__.oct");
...
//Close 
// PKG_ADD: autoload ("modbus_close", "__modbus__.oct");
...
//Free
// PKG_ADD: autoload ("modbus_free", "__modbus__.oct");
...
//Flush
// PKG_ADD: autoload ("modbus_flush", "__modbus__.oct");
...
//Read bits
// PKG_ADD: autoload ("modbus_read_bits", "__modbus__.oct");
...
//Write bits
// PKG_ADD: autoload ("modbus_write_bits", "__modbus__.oct");
...
//Read registers
// PKG_ADD: autoload ("modbus_read_registers", "__modbus__.oct");
...
//Write registers
// PKG_ADD: autoload ("modbus_write_registers", "__modbus__.oct");
...
//Read input bits
// PKG_ADD: autoload ("modbus_read_input_bits", "__modbus__.oct");
...
// PKG_ADD: autoload ("modbus_read_input_registers", "__modbus__.oct");
